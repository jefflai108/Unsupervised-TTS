...
train_config=conf/tuning/sls_train_gst+xvector_transformer-guided_attn_v1.yaml
...
./tts-nopunc.sh \
    ...
    --tag sls_train_gst+xvector_transformer-guided_attn_v1_raw_phn_none-nopunc \
