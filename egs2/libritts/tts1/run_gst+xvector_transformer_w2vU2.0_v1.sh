...
for inference_model in valid.loss.best; do
./tts-w2vU2.0_v1.sh \
    --ngpu 8 \
    --lang en \
    --feats_type raw \
    ...
    --tag sls_train_gst+xvector_transformer_raw_phn_none-w2vU2.0_v1 \
    --tts_stats_dir exp/tts_stats_raw_phn_none-w2vU2.0_v1 \
    --inference_model ${inference_model}.pth \
    --inference_tag decode_speaker${speaker}_transformer_${inference_model}_hifigan \
