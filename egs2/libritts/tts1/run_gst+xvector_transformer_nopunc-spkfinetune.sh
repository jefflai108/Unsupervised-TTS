...
train_set=alex_train-clean-460_nopunc-${speaker}-train
valid_set=alex_train-clean-460_nopunc-${speaker}-valid
test_sets=alex_test-clean_nopunc-${speaker}
...
train_args="--init_param exp/tts_sls_train_gst+xvector_transformer_raw_phn_none-nopunc/valid.loss.best.pth"
...
./tts-nopunc.sh \
    ...
    --tag sls_train_gst+xvector_transformer_raw_phn_none-nopunc-spkfinetune-${speaker} \
    --tts_stats_dir exp/tts_stats_raw_phn_none-nopunc-spkfinetune-${speaker} \
